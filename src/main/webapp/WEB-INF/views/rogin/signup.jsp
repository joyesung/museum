			 ...
			 $.ajax({
		        ...
		        success : function(data){
		           if(!data.isMember){
		        	   ...
		        	   alert('이미 가입된 회원입니다.')
		        	   isCheck = false;//이코드가 없으면 아이디가 중복된 회원이라도 가입이 된다.
		           }
		        }
		    });
		})
	...
	<div> 
		<div class="offset-4 col-4 border border-dark mt-5"> 
			...
			<form method="post" action="" id="signup"> 
				...
				<div>
					<button type="button" class="btn btn-outline-success offset-4 col-7" id="dup">아이디중복확인</button>
				</div>
				<div class="row"> 
